<div>
    ...
    <x-jet-dialog-modal wire:model="managingApiTokenPermissions">
        ...
        <x-slot name="footer">
            ...
            <x-jet-button class="ltr:ml-3 rtl:mr-3" wire:click="updateApiToken" wire:loading.attr="disabled">
                {{ __('Save') }}
            </x-jet-button>
        </x-slot>
    </x-jet-dialog-modal>
    ...
    <x-jet-confirmation-modal wire:model="confirmingApiTokenDeletion">
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button class="ltr:ml-3 rtl:mr-3" wire:click="deleteApiToken" wire:loading.attr="disabled">
                {{ __('Delete') }}
            </x-jet-danger-button>
        </x-slot>
