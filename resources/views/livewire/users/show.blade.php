<div class="p-5 dark:bg-gray-800">
    ...
    <div class="modal-action">
        <x-jet-button class="mx-1" wire:click.prevent="$emit('edit',{{$userData->id}})">{{__('Edit')}}</x-jet-button>
        <x-jet-danger-button class="mx-1" wire:click.prevent="$emit('delete',{{json_encode([$userData->id])}})">{{__('Delete')}}
        </x-jet-danger-button>
    </div>
